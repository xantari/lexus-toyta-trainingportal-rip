...
def download_manual(driver, t, id):
    ...
    for i in root.iter("item"):
        ...
        f_parts = href.split('/')
        f_p = "C:\\tis-rip-master\\" + os.path.join(id, "html", f_parts[len(f_parts)-1])
        pdf_p = "C:\\tis-rip-master\\" + os.path.join(id, "pdf", f_parts[len(f_parts)-1][:-5] + ".pdf")
        ...
        #        time.sleep(5.0)
        #        incomplete = False
        #        for f in os.listdir("C:\\tis-rip-master\\download"):
...
#
        ...
        #    dest_file = None
        #    while len(os.listdir("C:\\tis-rip-master\\download")) < 1:
        #        time.sleep(5.0)
#
        #    for f in os.listdir("C:\\tis-rip-master\\download"):
        #        print(f)
        ...
        #        continue
        #    
        #    shutil.move(os.path.join("C:\\tis-rip-master\\download", dest_file), pdf_p)
        #    print("\tDone")
        #else:
...
if __name__ == "__main__":
    ...
    chrome_options.add_argument("user-data-dir=C:\\tis-rip-master\\user-data")
